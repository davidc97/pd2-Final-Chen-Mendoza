...
static class Sector extends Being {
  ...
  Rectangle rectangle; //the rectangle
    ...
    int x, y; //coordinates in sector space, not pixel space. (1unit per sector)

  //create a new sector at sector coordinates x,y,
  //adds platforms to given PlatformGroup with given density
