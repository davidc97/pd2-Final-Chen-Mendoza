...
void setup() {
  ...
  menuButtons[0] = new Button("New game", new PVector(100, 100), 32, color(0), color(255, 0, 0));
  menuButtons[1] = new Button("Continue", new PVector(100, 300), 32, color(0), color(255, 0, 0));
  menuButtons[2] = new Button("Options", new PVector(100, 500), 32, color(0), color(255, 0, 0));
  drawBoxes = false;
}
